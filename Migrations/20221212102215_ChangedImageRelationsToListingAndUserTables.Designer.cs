...
namespace Eclipse_Market.Migrations
{
    ...
    [Migration("20221212102215_ChangedImageRelationsToListingAndUserTables")]
    partial class ChangedImageRelationsToListingAndUserTables
    {
            ...
            modelBuilder.Entity("Eclipse_Market.Models.DB.ListingImage", b =>
                {
                    b.HasOne("Eclipse_Market.Models.DB.Listing", "Listing")
                        .WithOne("Images")
                        .HasForeignKey("Eclipse_Market.Models.DB.ListingImage", "ListingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Eclipse_Market.Models.DB.UserImage", b =>
                {
                    b.HasOne("Eclipse_Market.Models.DB.User", "User")
                        .WithOne("Image")
                        .HasForeignKey("Eclipse_Market.Models.DB.UserImage", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
